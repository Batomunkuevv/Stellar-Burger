...
import { DECREMENT_INGREDIENT } from '../../services/redux/actions/ingredients';
import { REMOVE_CONSTRUCTOR_INGREDIENT } from '../../services/redux/actions/constructor';
...
const ConstructorItem = ({ _id, name, type, price, image, index, handlerId, moveCard }) => {
    ...
    const removeIngredient = () => {
        dispatch({ type: DECREMENT_INGREDIENT, payload: { _id, type } })
        dispatch({ type: REMOVE_CONSTRUCTOR_INGREDIENT, payload: handlerId })
    }
