...
const LoginForm: FC = () => {
    ...
    return (
        <form action="#" onSubmit={handleFormSubmit} className={styles.form}>
            <div className="mb-6 text text_type_main-medium">Вход</div>
            <div className={classNames(styles.form__body, "mb-20")}>
                <EmailInput onChange={handleChange} value={values.email} name="email" isIcon={false} extraClass={styles.form__item} />

                <PasswordInput onChange={handleChange} value={values.password} name="password" extraClass={styles.form__item} />
