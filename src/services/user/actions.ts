...
export const signIn: AppThunk = (email: string, password: string, callback: any) => (dispatch) => {
...
export const signOut: AppThunk = (callback: any) => (dispatch: AppDispatch) => {
...
export const updateUser: AppThunk = (values: { [value: string]: string }) => (dispatch: AppDispatch) => {
...
export const updateToken: AppThunk = (afterRefresh: any) => (dispatch: AppDispatch) => {
